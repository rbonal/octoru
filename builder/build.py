...
def main():
    ...
    # robots.txt (with the sitemap directive) and the branded noindex 404 page are NOT
    # otherwise emitted by the build, so a clean `rm -rf generated` used to drop them and
    # break /robots.txt + the 404. Emit both here so every rebuild reproduces them exactly.
    _write("robots.txt", 'User-agent: *\nAllow: /\n\nSitemap: https://octoru.com/sitemap.xml\n')
    import base64 as _b64
    _write("404.html", _b64.b64decode(
        ""
    ).decode("utf-8"))
    print(f"[builder] built hubs + homepage + claim + advertise + {len(guide_urls)} guides + favicon + robots.txt + 404.html + sitemap.xml")
